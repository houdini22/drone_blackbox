...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        groupBoxStatus->setGeometry(QRect(10, 10, 491, 221));
        QFont font;
        ...
        groupBoxTitle->setGeometry(QRect(520, 10, 491, 221));
        ...
        groupBox->setGeometry(QRect(10, 240, 491, 311));
        ...
        groupBox_2->setGeometry(QRect(520, 240, 491, 311));
