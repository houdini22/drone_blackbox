...
QT_MOC_LITERAL(1, 20, 14), // "buttonsChanged"
QT_MOC_LITERAL(2, 35, 0), // ""
QT_MOC_LITERAL(3, 36, 14), // "ButtonsPressed"
QT_MOC_LITERAL(4, 51, 7), // "buttons"
QT_MOC_LITERAL(5, 59, 10) // "setButtons"

    },
    "ThreadGamepadUpdate\0buttonsChanged\0\0"
    "ButtonsPressed\0buttons\0setButtons"
};
...
void ThreadGamepadUpdate::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->buttonsChanged((*reinterpret_cast< ButtonsPressed(*)>(_a[1]))); break;
        case 1: _t->setButtons((*reinterpret_cast< ButtonsPressed(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (ThreadGamepadUpdate::*_t)(ButtonsPressed );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ThreadGamepadUpdate::buttonsChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ThreadGamepadUpdate::buttonsChanged(ButtonsPressed _t1)
{
