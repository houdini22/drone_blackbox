...
public:
    ...
    void setupUi(QDialog *DialogRadioSettings)
    {
        if (DialogRadioSettings->objectName().isEmpty())
            DialogRadioSettings->setObjectName(QStringLiteral("DialogRadioSettings"));
        ...
        inputLeftXmin->setObjectName(QStringLiteral("inputLeftXmin"));
        ...
        inputLeftXmax->setObjectName(QStringLiteral("inputLeftXmax"));
        ...
        inputLeftYmax->setObjectName(QStringLiteral("inputLeftYmax"));
        inputLeftYmax->setGeometry(QRect(330, 70, 101, 32));
        inputLeftYmin = new QLineEdit(groupBox_3);
        inputLeftYmin->setObjectName(QStringLiteral("inputLeftYmin"));
        ...
        inputRightYmax->setObjectName(QStringLiteral("inputRightYmax"));
        inputRightYmax->setGeometry(QRect(330, 70, 101, 32));
        inputRightYmin = new QLineEdit(groupBox_5);
        inputRightYmin->setObjectName(QStringLiteral("inputRightYmin"));
        ...
        inputRightXmax->setObjectName(QStringLiteral("inputRightXmax"));
        ...
        inputRightXmin->setObjectName(QStringLiteral("inputRightXmin"));
