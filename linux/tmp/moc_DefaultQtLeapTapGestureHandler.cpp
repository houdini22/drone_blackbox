...
struct qt_meta_stringdata_QtLeapMotion__DefaultQtLeapTapGestureHandler_t {
    QByteArrayData data[1];
    char stringdata0[45];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QtLeapMotion__DefaultQtLeapTapGestureHandler_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QtLeapMotion__DefaultQtLeapTapGestureHandler_t qt_meta_stringdata_QtLeapMotion__DefaultQtLeapTapGestureHandler = {
    {
QT_MOC_LITERAL(0, 0, 44) // "QtLeapMotion::DefaultQtLeapTa..."

    },
    "QtLeapMotion::DefaultQtLeapTapGestureHandler"
};
...
QT_INIT_METAOBJECT const QMetaObject QtLeapMotion::DefaultQtLeapTapGestureHandler::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QtLeapMotion__DefaultQtLeapTapGestureHandler.data,
      qt_meta_data_QtLeapMotion__DefaultQtLeapTapGestureHandler,  qt_static_metacall, nullptr, nullptr}
};
...
void *QtLeapMotion::DefaultQtLeapTapGestureHandler::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QtLeapMotion__DefaultQtLeapTapGestureHandler.stringdata0))
