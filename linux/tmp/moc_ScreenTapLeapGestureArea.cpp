...
struct qt_meta_stringdata_QtLeapMotion__ScreenTapLeapGestureArea_t {
    QByteArrayData data[10];
    char stringdata0[195];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QtLeapMotion__ScreenTapLeapGestureArea_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QtLeapMotion__ScreenTapLeapGestureArea_t qt_meta_stringdata_QtLeapMotion__ScreenTapLeapGestureArea = {
    {
QT_MOC_LITERAL(0, 0, 38), // "QtLeapMotion::ScreenTapLeapGe..."
QT_MOC_LITERAL(1, 39, 19), // "gesturesListChanged"
QT_MOC_LITERAL(2, 59, 0), // ""
QT_MOC_LITERAL(3, 60, 14), // "gestureStarted"
QT_MOC_LITERAL(4, 75, 31), // "QtLeapMotion::QtLeapTapGesture*"
...
QT_MOC_LITERAL(9, 156, 38) // "QList<QtLeapMotion::QtLeapTap..."
...
void QtLeapMotion::ScreenTapLeapGestureArea::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (ScreenTapLeapGestureArea::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ScreenTapLeapGestureArea::gesturesListChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (ScreenTapLeapGestureArea::*)(QtLeapMotion::QtLeapTapGesture * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ScreenTapLeapGestureArea::gestureStarted)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (ScreenTapLeapGestureArea::*)(QtLeapMotion::QtLeapTapGesture * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ScreenTapLeapGestureArea::gestureUpdated)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (ScreenTapLeapGestureArea::*)(QtLeapMotion::QtLeapTapGesture * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ScreenTapLeapGestureArea::gestureEnded)) {
                *result = 3;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject QtLeapMotion::ScreenTapLeapGestureArea::staticMetaObject = {
    { &AbstractGestureArea::staticMetaObject, qt_meta_stringdata_QtLeapMotion__ScreenTapLeapGestureArea.data,
      qt_meta_data_QtLeapMotion__ScreenTapLeapGestureArea,  qt_static_metacall, nullptr, nullptr}
};
...
void *QtLeapMotion::ScreenTapLeapGestureArea::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QtLeapMotion__ScreenTapLeapGestureArea.stringdata0))
