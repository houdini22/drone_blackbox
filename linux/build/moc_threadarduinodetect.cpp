...
QT_MOC_LITERAL(1, 20, 26), // "signalArduinoStatusChanged"
QT_MOC_LITERAL(2, 47, 0), // ""
QT_MOC_LITERAL(3, 48, 5), // "value"
QT_MOC_LITERAL(4, 54, 12), // "deviceString"
QT_MOC_LITERAL(5, 67, 22), // "slotSendingDataChanged"
QT_MOC_LITERAL(6, 90, 12) // "SendingData*"

    },
    "ThreadArduinoDetect\0signalArduinoStatusChanged\0"
    "\0value\0deviceString\0slotSendingDataChanged\0"
    "SendingData*"
};
...
void ThreadArduinoDetect::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (ThreadArduinoDetect::*)(int , QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ThreadArduinoDetect::signalArduinoStatusChanged)) {
                *result = 0;
                return;
            }
        }
