...
static const char qt_meta_stringdata_SteeringGamepad[] = {
    "SteeringGamepad\0\0"
    "signalSteeringDataChanged(SteeringData*)\0"
    "slotGamepadIsConnected(bool)\0"
    "slotButtonsChanged(ButtonsPressed)\0"
};
...
const QMetaObjectExtraData SteeringGamepad::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject SteeringGamepad::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_SteeringGamepad,
      qt_meta_data_SteeringGamepad, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &SteeringGamepad::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_SteeringGamepad))
        return static_cast<void*>(const_cast< SteeringGamepad*>(this));
    if (!strcmp(_clname, "SteeringInterface"))
        return static_cast< SteeringInterface*>(const_cast< SteeringGamepad*>(this));
