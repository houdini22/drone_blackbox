...
struct qt_meta_stringdata_QtLeapMotion__DefaultQtLeapTouchHandler_t {
    QByteArrayData data[1];
    char stringdata0[40];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QtLeapMotion__DefaultQtLeapTouchHandler_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QtLeapMotion__DefaultQtLeapTouchHandler_t qt_meta_stringdata_QtLeapMotion__DefaultQtLeapTouchHandler = {
    {
QT_MOC_LITERAL(0, 0, 39) // "QtLeapMotion::DefaultQtLeapTo..."

    },
    "QtLeapMotion::DefaultQtLeapTouchHandler"
};
...
QT_INIT_METAOBJECT const QMetaObject QtLeapMotion::DefaultQtLeapTouchHandler::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QtLeapMotion__DefaultQtLeapTouchHandler.data,
      qt_meta_data_QtLeapMotion__DefaultQtLeapTouchHandler,  qt_static_metacall, nullptr, nullptr}
};
...
void *QtLeapMotion::DefaultQtLeapTouchHandler::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QtLeapMotion__DefaultQtLeapTouchHandler.stringdata0))
        return static_cast<void*>(this);
    if (!strcmp(_clname, "QtLeapTouchHandlerInterface"))
        return static_cast< QtLeapTouchHandlerInterface*>(this);
    ...
    if (!strcmp(_clname, "org.qtproject.QtLeapMotion.QtLeapTouchHandlerInterface/1.0"))
        return static_cast< QtLeapMotion::QtLeapTouchHandlerInterface*>(this);
