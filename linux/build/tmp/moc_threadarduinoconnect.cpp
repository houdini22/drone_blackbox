...
QT_MOC_LITERAL(1, 21, 24), // "signalSendingDataChanged"
QT_MOC_LITERAL(2, 46, 0), // ""
QT_MOC_LITERAL(3, 47, 12), // "SendingData*"
QT_MOC_LITERAL(4, 60, 22), // "slotSendingDataChanged"
QT_MOC_LITERAL(5, 83, 11) // "sendingData"

    },
    "ThreadArduinoConnect\0signalSendingDataChanged\0"
    "\0SendingData*\0slotSendingDataChanged\0"
    "sendingData"
};
...
void ThreadArduinoConnect::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ThreadArduinoConnect *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (ThreadArduinoConnect::*)(SendingData * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ThreadArduinoConnect::signalSendingDataChanged)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject ThreadArduinoConnect::staticMetaObject = { {
    ...
    qt_meta_stringdata_ThreadArduinoConnect.data,
    qt_meta_data_ThreadArduinoConnect,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
// SIGNAL 0
void ThreadArduinoConnect::signalSendingDataChanged(SendingData * _t1)
{
