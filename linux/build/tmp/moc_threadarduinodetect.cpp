...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ThreadArduinoDetect_t, stringdata0) + ofs \
...
QT_MOC_LITERAL(1, 20, 24), // "signalSendingDataChanged"
QT_MOC_LITERAL(2, 45, 0), // ""
QT_MOC_LITERAL(3, 46, 12), // "SendingData*"
QT_MOC_LITERAL(4, 59, 22) // "slotSendingDataChanged"

    },
    "ThreadArduinoDetect\0signalSendingDataChanged\0"
...
void ThreadArduinoDetect::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ThreadArduinoDetect *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (ThreadArduinoDetect::*)(SendingData * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ThreadArduinoDetect::signalSendingDataChanged)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject ThreadArduinoDetect::staticMetaObject = { {
    ...
    qt_meta_stringdata_ThreadArduinoDetect.data,
    qt_meta_data_ThreadArduinoDetect,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *ThreadArduinoDetect::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ThreadArduinoDetect.stringdata0))
...
// SIGNAL 0
void ThreadArduinoDetect::signalSendingDataChanged(SendingData * _t1)
{
