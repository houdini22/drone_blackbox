...
/*	1	*/	{MODE_AFHDS2A,	PPM_IBUS,       0	,	P_HIGH	,	NO_AUTOBIND	,	0		},
/*	2	*/	{MODE_AFHDS2A,	PPM_SBUS,	    1	,	P_HIGH	,	NO_AUTOBIND	,	0		},
/*	3	*/	{MODE_AFHDS2A,  PWM_IBUS,	    2	,	P_HIGH	,	NO_AUTOBIND	,	0		},	// option=fine freq tuning
/*	4	*/	{MODE_AFHDS2A,	PWM_SBUS,	    3	,	P_HIGH	,	NO_AUTOBIND	,	0		},
/*	5	*/	{MODE_AFHDS2A,	PPM_IBUS,	    4	,	P_HIGH	,	NO_AUTOBIND	,	0		},
/*	6	*/	{MODE_AFHDS2A,	PPM_SBUS,	    5	,	P_HIGH	,	NO_AUTOBIND	,	6		},	// option=number of channels
/*	7	*/	{MODE_AFHDS2A,	PWM_IBUS,	    6	,	P_HIGH	,	NO_AUTOBIND	,	0		},
/*	8	*/	{MODE_AFHDS2A,	PWM_SBUS,	    7	,	P_HIGH	,	NO_AUTOBIND	,	0		},
/*	9	*/	{MODE_AFHDS2A,	PPM_IBUS,	    8	,	P_HIGH	,	NO_AUTOBIND	,	0		},
/*	10	*/	{MODE_AFHDS2A,	PPM_SBUS,	    9	,	P_HIGH	,	NO_AUTOBIND	,	0		},
/*	11	*/	{MODE_AFHDS2A,	PWM_IBUS,	    10	,	P_HIGH	,	NO_AUTOBIND	,	0		},
/*	12	*/	{MODE_AFHDS2A,	PWM_SBUS,    	11	,	P_HIGH	,	NO_AUTOBIND	,	0		},
/*	13	*/	{MODE_AFHDS2A,	PPM_IBUS,	    12	,	P_HIGH	,	NO_AUTOBIND	,	0		},
/*	14	*/	{MODE_AFHDS2A,  PPM_SBUS,	    13	,	P_HIGH	,	NO_AUTOBIND	,	0		},
/*	15	*/	{MODE_AFHDS2A,	PWM_IBUS,	    14	,	P_HIGH	,	NO_AUTOBIND	,	0		}
};
